		...
		<div class="flowBox">
			...
			<form action="index/deletecart.action" method="post">
				...
				<table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
					<tr>
						<td bgcolor="#ffffff"><a href="index.jsp"><img src="themes/ecmoban_dangdang/images/continue.gif"
								alt="continue" /> </a></td>
						<td bgcolor="#ffffff" align="right"><a href="index/preCheckout.action"><img
								src="themes/ecmoban_dangdang/images/checkout.gif" alt="checkout" /> </a></td>
					</tr>
				</table>
			</form>
		</div>
